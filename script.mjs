...
const LOCALES = {
    en: {
        ...
        'history.max_period':'Max. Price for period:','history.min_period':'Min. Price for period:',
    ...
    ru: {
        ...
        'history.max_period':'Макс. цена за период:','history.min_period':'Мин. цена за период:',
